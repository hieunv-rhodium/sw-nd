<template>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form id="search" class="margin-top-10 margin-bott-10">
                Search <input name="query" v-model="query" @keyup="search(query)">
            </form>
            <div class="pull-right padd-right-20">
                {{ total }} Total Results
            </div>
            ...
            <section class="panel">
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <tr v-for="(row, itemObjKey) in gridData">
                            <td>
                                {{ itemObjKey+1 }}
                            </td>
                            <td>
                            ...
                            <td>
                                <img v-bind:src="'/imgs/avatar/' + row.Avatar " class="img-circle img-avatar-list" alt="User Image">
                            </td>
                            <td>
            ...
            <section class="panel" style="background:none; border: none;">
    ...
    export default {
        ...
        data: function () {
            ...
            return {
                ...
                query: '',
                gridColumns: ['Order','Id', 'Avatar', 'Name','Email', 'Admin' , 'Subscribed' ,'Status' , 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
